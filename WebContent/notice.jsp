...
/* 페이지 규격 */
.wrapper { width:1024px; background-color:whitesmoke; margin:0 auto; padding:0 150px 30px; }
...
#notice a:hover { ext-decoration:underline; }
...
<body>
	...
	<div class="wrapper">
		...
		<table id="notice">
			...
			<tr>
				<td id="no-title">
					<a href="notice_detail.jsp?no=<%=a.getNo()%>"><%=a.getTitle() %></a>
				</td>
				<td><%=a.getCredte() %></td>
			</tr>
			<%} %>
		...
		<div class="btn_group">
			...
			<ul class="pbtnlist">
				...
				<li><a class="pbtn" href="notice.jsp?p=<%=pageBS+i %>"><%=pageBS+i %></a></li>
				<%} %>
	 		</ul>
